...
class zipper():
    def __init__(self):
        ...
        self.labelName = Label(self.window,text="ZIP FILE NAME:",bg="gainsboro")
        self.labelName.place(x=10,y=216)
        self.btnClear = Button(self.window,text="CLEAR ALL",command=self.clear_all)
        ...
        self.btnSelect = Button(self.window,text="ADD/REMOVE",bg="orange",width=31,command=self.add_element)
