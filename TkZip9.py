...
class zipper():
    def __init__(self):
        ...
        self.entryName.place(x=100,y=256)
        self.labelName = tk.Label(self.window,text="ZIP FILE NAME:")
        self.labelName.place(x=10,y=256)
        self.btnClear = tk.Button(self.window,text="CLEAR ALL",bg="gray89",width=73,command=self.clear_all)
        self.btnClear.place(x=10,y=213)
        self.entryDirs = tk.Listbox(self.canvas,width=34,height=16)
        self.entryDirs.pack()
