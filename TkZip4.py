...
class zipper():
    def __init__(self):
        ...
        self.entryName = Entry(self.window,width=28,textvariable=self.folderNme)
        self.entryName.place(x=133,y=216)
        self.labelName = Label(self.window,text="ZIP FILE NAME (OPT):",bg="gainsboro")
        self.labelName.place(x=10,y=216)
        self.btnClear = Button(self.window,text="CLEAR",width=9,command=self.clear_all)
        self.btnClear.place(x=446,y=212)
        ...
        self.btnSelectAll = Button(self.window,text="INSERT ALL",bg="orange",width=15,command=self.add_all)
