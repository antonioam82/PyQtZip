...
class zipper():
    def __init__(self):
        ...
        self.btnSelect = Button(self.window,text="AÑADIR/QUITAR",bg="orange",width=13,command=self.add_element)
        self.btnSelect.place(x=537,y=277)
        self.btnSelectAll = Button(self.window,text="SELECT ALL",bg="orange",width=13)
